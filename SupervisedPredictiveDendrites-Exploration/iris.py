...
def learn(x0, x2, alpha=0.001, beta=0.0,c=1.0):
    ...
    e1b = x1 - w2b @ x2
    w2b = w2b + alpha * (1-g(x1)/2) * e1b @ x2.transpose()
    ...
    w1s = (1-beta) * w1s + beta * x1 @ x1.transpose()
...
for train_index, test_index in kf.split(X):
    ...
    for e in range(epochs):
        ...
        print(f"Average angle between rows of w2f at epoch {e}: {avg_angle:.2f} degrees")
